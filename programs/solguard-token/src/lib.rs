...
declare_id!("SoLGuaRDToKeN1111111111111111111111111111111");
...
pub mod solguard_token {
    ...
    pub fn buy_tokens(ctx: Context<BuyTokens>, sol_amount: u64) -> Result<()> {
        ...
        emit!(TokensPurchased {
            ...
            new_price: calculate_current_price(token_state.total_supply, token_state.bonding_curve_k),
        });
...
fn calculate_tokens_for_sol(sol_amount: u64, current_supply: u64, k: u64) -> u64 {
    ...
    let sol_scaled = sol_amount as u128 * k as u128;
    let supply_squared = (current_supply as u128).pow(2);
    let new_supply_squared = sol_scaled + supply_squared;
    let new_supply = (new_supply_squared as f64).sqrt() as u64;
...
fn calculate_sol_for_tokens(token_amount: u64, current_supply: u64, k: u64) -> u64 {
    ...
    let current_squared = (current_supply as u128).pow(2);
    let new_squared = (new_supply as u128).pow(2);
    let sol_amount = (current_squared - new_squared) / k as u128;
    sol_amount as u64
}

fn calculate_current_price(supply: u64, k: u64) -> u64 {
    // Price = k * supply
    (supply as u128 * k as u128 / 1_000_000_000) as u64
}
